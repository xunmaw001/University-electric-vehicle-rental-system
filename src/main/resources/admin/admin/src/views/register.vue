<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","backgroundAttachment":"fixed","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20220805/b1cb6ef3342944638d01cf6af54cc78e.png)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"40px 20px 20px 400px","boxShadow":"0 0px 0px rgba(64, 158, 255, .8)","margin":"0","borderRadius":"10px","background":"url(http://codegen.caihongy.cn/20220725/c695a127c79747fc80e792b367f071ca.png)","width":"1200px","backgroundSize":"cover","height":"800px"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"120px","fontSize":"24px","fontWeight":"bold"}' class="title">基于springboot的高校电动车租赁系统注册</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">联系方式</div>
				...
				<button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0px 4px 10px 0px #CFD5F8;","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"10px 0","background":"#4E5A6B","width":"80%","fontSize":"18px","height":"80px"}' type="button" class="r-btn" @click="login()">注册</button>
...
<style lang="scss" scoped>
	.container {
	  position: relative;
	  background: url(http://codegen.caihongy.cn/20220805/b1cb6ef3342944638d01cf6af54cc78e.png);
