<template>
	<div style="height: 100%;">
		...
		<el-main :style='"vertical" == "vertical" ? {"minHeight":"100%","width":"100%","padding":"0","margin":"0","position":"relative","display":"block"} : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<index-header :style='{"boxShadow":"0px 2px 6px 0px rgba(0,0,0,0.2)","padding":"8px 20px","alignItems":"center","background":"#C2CDE4","display":"flex","width":"100%","position":"relative","justifyContent":"center","zIndex":"1002"}'></index-header>
			...
			<bread-crumbs :title="title" :style='{"padding":"0 20px","margin":"20px auto 10px 240px","borderColor":"#eee","alignItems":"center","borderWidth":"0","background":"#98A3A9","display":"flex","width":"calc(100% - 270px)","borderStyle":"solid","height":"40px"}' class="bread-crumbs"></bread-crumbs>
